...
window.Typekit.config = {
    a: "646866",
    dl: "AAAA5wAAAAremCNvmvgJFPnlW1eY2t2h7EJK851qBQMOU11NAAAAQA",
    fi: [10870, 17016],
    fc: [
        {
            id: 10870,
            family: "adonis-web",
            src: "https://use.typekit.net/af/807888/00000000000000000001007d/27/{format}{?primer,subset_id,fvd,v}",
            descriptors: { weight: "400", style: "normal", stretch: "normal", display: "auto", variable: false, subset_id: 2 },
        },
        {
            id: 17016,
            family: "adelle-sans",
            src: "https://use.typekit.net/af/a96fc4/00000000000000007735a1de/30/{format}{?primer,subset_id,fvd,v}",
            descriptors: { weight: "400", style: "normal", stretch: "normal", display: "auto", variable: false, subset_id: 2 },
        },
    ],
    fn: ["adelle-sans", ["n4"], "adonis-web", ["n4"]],
    hn: "use.typekit.net",
    ht: "tk",
    js: "1.21.0",
    kt: "646866_655401e262a0492c6c0471cf",
    l: "typekit",
    ps: 2,
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2023-11-14 23:25:30 UTC"}*/
(function (window, document, undefined) {
    ...
    function F(a, b) {
        return new ma(b, a.g, { weight: a.weight, style: a.style, stretch: a.stretch, B: a.B, C: a.C, display: a.display });
    }
    function D(a) {
    ...
    function ra(a, b, c) {
        for (var d = [], e = 0; e < b.length; e++) {
            var f = b[e],
                g = H(new G(a.g), { format: f, primer: a.B, subset_id: a.C, fvd: D(a), extension: sa(f), token: c, v: "3" });
        ...
        var a = this.m.g.document,
            ...
            d = new Promise(function (d, e) {
                function k() {
                    l() - c >= b.g
                        ? e()
                        : a.fonts.load(b.b.style + " " + b.b.weight + " 300px " + (b.j ? E(b.b) : b.b.b), b.o).then(
                              function (a) {
            ...
            active: function () {
                ...
                if (d.m) {
                    var a = d.m,
                        ...
                        v = [];
                    window.Typekit
                        ? (window.Typekit.fonts || (window.Typekit.fonts = []), (v = window.Typekit.fonts))
                        : window.TypekitPreview && (window.TypekitPreview.fonts || (window.TypekitPreview.fonts = []), (v = window.TypekitPreview.fonts));
                    for (var w = 0; w < a.b.length; w++) {
                        for (var qa = !1, Y = 0; Y < v.length; Y++)
                            if (a.b[w] === v[Y]) {
                                qa = !0;
                                break;
                            }
                    ...
                    n.length && Da(H(c, { s: a.j, k: a.o, app: k, ht: a.i, h: b, f: n.join("."), a: a.g, js: a.version, e: "js", _: (+new Date()).toString() }));
                }
            },
            inactive: function () {
                if (e) {
